...
pub fn digest_256(message: &[u8]) -> [u8; 32] {
...
pub fn digest_512(message: &[u8]) -> [u8; 64] {
    let mut chunks = message.to_vec();
...
mod tests {
    ...
    fn test_digest_256() {
        ...
        assert_eq!(expected_hash, digest_256(b""));
    }
